...
@Component({
  selector: 'app-jp-technology',
  templateUrl: './jp-technology.component.html',
  styleUrls: ['./jp-technology.component.css']
})
export class JpTechnologyComponent implements OnInit {
